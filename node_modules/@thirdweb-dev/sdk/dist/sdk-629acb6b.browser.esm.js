import { cr as RPCConnectionHandler, aO as resolveAddress, cs as signTypedDataInternal, X as getDefaultGasOverrides, aU as ChainId, b0 as getChainProvider, ct as ContractWrapper, aX as NATIVE_TOKEN_ADDRESS, cu as extractFeatures, ae as detectFeatures, aT as getMultichainRegistryAddress, aL as fetchPublishedContractFromPolygon, aK as THIRDWEB_DEPLOYER$1, aM as fetchAndCacheDeployMetadata, aA as getCreate2FactoryAddress, aI as encodeConstructorParamsForImplementation, aH as computeDeploymentInfo, ay as isContractDeployed, J as fetchContractMetadataFromAddress, ar as fetchSourceFilesFromMetadata, a4 as extractConstructorParamsFromAbi, a7 as resolveContractUriFromAddress, aS as getContractPublisherAddress, ad as fetchExtendedReleaseMetadata, bl as AbiSchema, au as COMMON_FACTORY, az as isEIP155Enforced, cv as CUSTOM_GAS_FOR_CHAIN, aJ as getCreate2FactoryDeploymentInfo, aQ as CONTRACT_ADDRESSES, cw as AddressZero, aF as computeForwarderAddress, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bH as CommonPlatformFeeSchema, bG as CommonPrimarySaleSchema, bI as CommonTrustedForwarderSchema, bD as CommonContractSchema, bF as CommonRoyaltySchema, bJ as CommonSymbolSchema, aD as computeDeploymentAddress, aC as getInitBytecodeWithSalt, aV as setSupportedChains, j as getContractTypeForRemoteName, b5 as getSignerAndProvider, an as getCompositeABI, b3 as isChainConfig, aR as getContractAddressByChainId, cx as getProcessEnv, bT as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, a$ as EventType } from './index-5db81774.browser.esm.js';
import { ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-4bda8a4e.browser.esm.js';
...
import { c as buildTransactionFunction, T as Transaction, f as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-6a0f2e48.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-d928e91b.browser.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-1fffd784.browser.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployWithThrowawayDeployer-e08b1575.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-4bfd9150.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
