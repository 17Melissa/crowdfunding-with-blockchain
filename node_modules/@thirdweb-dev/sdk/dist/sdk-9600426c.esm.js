...
import { c as buildTransactionFunction, T as Transaction, f as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-95e27fc2.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-48c29937.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-94ddb2df.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployWithThrowawayDeployer-a0f4e5d0.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-5895481b.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
